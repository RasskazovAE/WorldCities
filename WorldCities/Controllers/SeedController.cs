...
namespace WorldCities.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        {
            // setup the default role manager
            ...
            {
                // create new a admin ApplicationUser account
            ...
            {
                // create new a standard ApplicationUser account
                ...
                await _userManager.CreateAsync(user_User, "Q1w2e3r4");

                // assing the "RegisteredUser" role
